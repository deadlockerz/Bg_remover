...
const onSubmit = (data) => {
  console.log(data);
   ...
   const handleSignUp =(e)=>{
    e.preventDefault() //check it once
    axios.post('http://localhost:3030/signup',{ name , email , password })  // send data to server side
        ...
        <div className='mt-7 sm:mx-auto sm:w-full sm:max-w-sm'>
          ...
          >
            <div>
              ...
              <div className='mt-2'>
                <input
                  onChange={(e) => setName(e.target.value)} // to take the value
                  id='name'
                  name='name'
                  type='text'
                  autoComplete='name'
            ...
            <div>
              ...
              <div className='mt-2'>
                <input
                  onChange={(e) => setEmail(e.target.value)} // to take the value
            ...
            <div>
              ...
              <div className='mt-2'>
                <input
                                  onChange={(e) => setPassword(e.target.value)} // to take the value
                                  {...register("password", {
